...
country.title(f'{list_sorted[3][0]} Stats')

# ***City1***
# ***Definition***
# Title
name = Label(country, text=f'{list_sorted[3][0]}', font=bold_25, bg='#b3b3b3', fg='white')
...
is_shield_city1 = Checkbutton(city1_frame, text=f'   {dist.StatsOfCities(3)[0][0]}', variable=CheckShield1, onvalue=1, offvalue=0, font=bold_13, bg='#757575', fg='white') 
is_shield_city2 = Checkbutton(city2_frame, text=f'   {dist.StatsOfCities(3)[1][0]}', variable=CheckShield2, onvalue=1, offvalue=0, font=bold_13, bg='#757575', fg='white')
is_shield_city3 = Checkbutton(city3_frame, text=f'   {dist.StatsOfCities(3)[2][0]}', variable=CheckShield3, onvalue=1, offvalue=0, font=bold_13, bg='#757575', fg='white')
is_shield_city4 = Checkbutton(city4_frame, text=f'   {dist.StatsOfCities(3)[3][0]}', variable=CheckShield4, onvalue=1, offvalue=0, font=bold_13, bg='#757575', fg='white')

# Checks if city is dead
if dist.StatsOfCities(3)[0][1] == '1':
	pass
else:
	is_shield_city1.configure(fg='red', font=overstrike)

if dist.StatsOfCities(3)[1][1] == '1':
	pass
else:
	is_shield_city2.configure(fg='red', font=overstrike)

if dist.StatsOfCities(3)[2][1] == '1':
	pass
else:
	is_shield_city3.configure(fg='red', font=overstrike)

if dist.StatsOfCities(3)[3][1] == '1':
	pass
else:
	is_shield_city4.configure(fg='red', font=overstrike)

# Checks if shield is on
if dist.StatsOfCities(3)[0][-2] == '1':
	is_shield_city1.select()
else:
	is_shield_city1.deselect()

if dist.StatsOfCities(3)[1][-2] == '1':
	is_shield_city2.select()
else:
	is_shield_city2.deselect()

if dist.StatsOfCities(3)[2][-2] == '1':
	is_shield_city3.select()
else:
	is_shield_city3.deselect()

if dist.StatsOfCities(3)[3][-2] == '1':
	is_shield_city4.select()
else:
	is_shield_city4.deselect()

# Cities' stats
city1_stats = Label(country, text=f"Развитие _________________{dist.StatsOfCities(3)[0][3]}\nУр.жизни _________________{dist.StatsOfCities(3)[0][2]}\nДоход _________________{dist.StatsOfCities(3)[0][-1]}", bg='#b3b3b3')
city2_stats = Label(country, text=f"Развитие _________________{dist.StatsOfCities(3)[1][3]}\nУр.жизни _________________{dist.StatsOfCities(3)[1][2]}\nДоход _________________{dist.StatsOfCities(3)[1][-1]}", bg='#b3b3b3')
city3_stats = Label(country, text=f"Развитие _________________{dist.StatsOfCities(3)[2][3]}\nУр.жизни _________________{dist.StatsOfCities(3)[2][2]}\nДоход _________________{dist.StatsOfCities(3)[2][-1]}", bg='#b3b3b3')
city4_stats = Label(country, text=f"Развитие _________________{dist.StatsOfCities(3)[3][3]}\nУр.жизни _________________{dist.StatsOfCities(3)[3][2]}\nДоход _________________{dist.StatsOfCities(3)[3][-1]}", bg='#b3b3b3')

# Life level and budget
life_level = Label(country, text="\nСРЕДНИЙ УРОВЕНЬ \nЖИЗНИ В СТРАНЕ:", fg='#fb0000', font=bold, bg='#b3b3b3')
life_level_persentage = Label(country, text=f'{list_sorted[3][2]}', fg='#fb0000', font=bold, bg='#b3b3b3')
budget = Label(country, text="\nДОСТУПНЫЙ\nБЮДЖЕТ:", fg='#0073e5', font=bold, bg='#b3b3b3')
budget_num = Label(country, text=f'{list_sorted[3][1]}', fg='#0073e5', font=bold, bg='#b3b3b3')
...
numNuclear = Label(country, text=f"{list_sorted[3][-2]}", bg='#b3b3b3')

if list_sorted[3][-3] == '1':
	isNuclear.select()
else:
	isNuclear.deselect()
...
if list_sorted[5][0] in list_sorted[0] or list_sorted[5][0] in list_sorted[3][9] :
	sanc5 = 'Да'
else:
	sanc5 = 'Нет'
