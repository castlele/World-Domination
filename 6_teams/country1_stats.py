...
life_level_persentage = Label(country, text=f'{list_sorted[1][2]}', fg='#fb0000', font=bold, bg='#b3b3b3')
...
if list_sorted[4][0] in list_sorted[1] or list_sorted[4][0] in list_sorted[1][9]:
	sanc4 = 'Да'
else:
	sanc4 = 'Нет'

if list_sorted[5][0] in list_sorted[1] or list_sorted[5][0] in list_sorted[1][9]:
	sanc5 = 'Да'
else:
	sanc5 = 'Нет'
