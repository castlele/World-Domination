...
live_level1 = Label(general, text=f'{list_sorted[0][2]}%', font=size_15, bg='#56f021', fg='white') 
live_level2 = Label(general, text=f'{list_sorted[1][2]}%', font=size_15, fg='white', bg='#b3b3b3')
live_level3 = Label(general, text=f'{list_sorted[2][2]}%', font=size_15, fg='white', bg='#b3b3b3')
live_level4 = Label(general, text=f'{list_sorted[3][2]}%', font=size_15, bg='red', fg='white')
...
country1_name = Label(country1_frame, text=f'{list_sorted[0][0]}', fg='white', bg='#56f021', font=bold)
country2_name = Label(country2_frame, text=f'{list_sorted[1][0]}', fg='white', bg='#b3b3b3', font=bold)
country3_name = Label(country3_frame, text=f'{list_sorted[2][0]}', fg='white', bg='#b3b3b3', font=bold)
country4_name = Label(country4_frame, text=f'{list_sorted[3][0]}', fg='white', bg='red', font=bold)

city1 = Label(country1_frame, text=f'{dist.StatsOfCities(0)[0][0]}', bg='#757575', font=bold_11)
city1_1 = Label(country1_frame, text=f'{dist.StatsOfCities(0)[1][0]}', bg='#757575', font=bold_11)
city1_2 = Label(country1_frame, text=f'{dist.StatsOfCities(0)[2][0]}', bg='#757575', font=bold_11)
city1_3 = Label(country1_frame, text=f'{dist.StatsOfCities(0)[3][0]}', bg='#757575', font=bold_11)

city2 = Label(country2_frame, text=f'{dist1.StatsOfCities(1)[0][0]}', bg='#757575', font=bold_11)
city2_1 = Label(country2_frame, text=f'{dist1.StatsOfCities(1)[1][0]}', bg='#757575', font=bold_11)
city2_2 = Label(country2_frame, text=f'{dist1.StatsOfCities(1)[2][0]}', bg='#757575', font=bold_11)
city2_3 = Label(country2_frame, text=f'{dist1.StatsOfCities(1)[3][0]}', bg='#757575', font=bold_11)

city3 = Label(country3_frame, text=f'{dist2.StatsOfCities(2)[0][0]}', bg='#757575', font=bold_11)
city3_1 = Label(country3_frame, text=f'{dist2.StatsOfCities(2)[1][0]}', bg='#757575', font=bold_11)
city3_2 = Label(country3_frame, text=f'{dist2.StatsOfCities(2)[2][0]}', bg='#757575', font=bold_11)
city3_3 = Label(country3_frame, text=f'{dist2.StatsOfCities(2)[3][0]}', bg='#757575', font=bold_11)

city4 = Label(country4_frame, text=f'{dist3.StatsOfCities(3)[0][0]}', bg='#757575', font=bold_11)
city4_1 = Label(country4_frame, text=f'{dist3.StatsOfCities(3)[1][0]}', bg='#757575', font=bold_11)
city4_2 = Label(country4_frame, text=f'{dist3.StatsOfCities(3)[2][0]}', bg='#757575', font=bold_11)
city4_3 = Label(country4_frame, text=f'{dist3.StatsOfCities(3)[3][0]}', bg='#757575', font=bold_11)
...
stats1 = Label(country1_frame, text=f'{dist.StatsOfCities(0)[0][3]}', fg='white', bg='#757575', font=bold_11)
stats1_1 =  Label(country1_frame, text=f'{dist.StatsOfCities(0)[1][3]}', fg='white', bg='#757575', font=bold_11)
stats1_2 =  Label(country1_frame, text=f'{dist.StatsOfCities(0)[2][3]}', fg='white', bg='#757575', font=bold_11)
stats1_3 = Label(country1_frame, text=f'{dist.StatsOfCities(0)[3][3]}', fg='white', bg='#757575', font=bold_11)

stats2 = Label(country2_frame, text=f'{dist1.StatsOfCities(1)[0][3]}', fg='white', bg='#757575', font=bold_11)
stats2_1 = Label(country2_frame, text=f'{dist1.StatsOfCities(1)[1][3]}', fg='white', bg='#757575', font=bold_11)
stats2_2 = Label(country2_frame, text=f'{dist1.StatsOfCities(1)[2][3]}', fg='white', bg='#757575', font=bold_11)
stats2_3 = Label(country2_frame, text=f'{dist1.StatsOfCities(1)[3][3]}', fg='white', bg='#757575', font=bold_11)

stats3 = Label(country3_frame, text=f'{dist2.StatsOfCities(2)[0][3]}', fg='white', bg='#757575', font=bold_11)
stats3_1 = Label(country3_frame, text=f'{dist2.StatsOfCities(2)[1][3]}', fg='white', bg='#757575', font=bold_11)
stats3_2 = Label(country3_frame, text=f'{dist2.StatsOfCities(2)[2][3]}', fg='white', bg='#757575', font=bold_11)
stats3_3 = Label(country3_frame, text=f' {dist2.StatsOfCities(2)[3][3]}', fg='white', bg='#757575', font=bold_11)

stats4 = Label(country4_frame, text=f'{dist3.StatsOfCities(3)[0][3]}', fg='white', bg='#757575', font=bold_11)
stats4_1 = Label(country4_frame, text=f'{dist3.StatsOfCities(3)[1][3]}', fg='white', bg='#757575', font=bold_11)
stats4_2 = Label(country4_frame, text=f'{dist3.StatsOfCities(3)[2][3]}', fg='white', bg='#757575', font=bold_11)
stats4_3 = Label(country4_frame, text=f'{dist3.StatsOfCities(3)[3][3]}', fg='white', bg='#757575', font=bold_11)
...
live_level1.place(width=50, height=50, x=500, y=100)
live_level2.place(width=50, height=50, x=500, y=250)
live_level3.place(width=50, height=50, x=500, y=400)
live_level4.place(width=50, height=50, x=500, y=550)

country1_frame.place(width=500, height=150, y=50)
country2_frame.place(width=500, height=150, y=200)
country3_frame.place(width=500, height=150, y=350)
country4_frame.place(width=500, height=150, y=500)
